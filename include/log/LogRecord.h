...
namespace CLSN {
    ...
    class LogRecord {
    public:
        explicit LogRecord(const LoggerBase *logger,
                  time_t time,
                  std::string &&file,
                  unsigned short line,
                  LogLevel level,
        ...
        const LoggerBase *getLogger() const noexcept {
            return logger;
        }
        ...
        inline unsigned short getLine() const noexcept {
            return line;
        }
        ...
        inline pthread_t getPid() const noexcept {
            return pid;
        }

        inline std::stringstream &getMessage() noexcept {
            return message;
        }

        inline const std::stringstream &getMessage() const noexcept {
            return message;
        }
