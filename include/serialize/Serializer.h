...
namespace CLSN {
    ...
    private:
        ...
        template<typename T>
        inline std::enable_if_t<!has_serialize_v<Drive, T> >
        serializeImpl(T &&arg) {
        ...
        template<typename T>
        inline std::enable_if_t<has_member_serialize_func_v<Drive, T>>
        serializeImpl(T &&arg) {
    ...
    private:
        ...
        template<typename T>
        inline std::enable_if_t<!has_deserialize_v<Drive, T> && !has_load_and_construct_v<Drive, T>>
        deSerializeImpl(T &&arg) {
            static_assert(has_deserialize_v<Drive, T> || has_load_and_construct_v<Drive, T>,
                          "type T has no deserialize func");
        }
