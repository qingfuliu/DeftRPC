...
static inline uint32_t Le32FromHost(uint32_t x) { return x; }
static inline uint32_t HostFromLe32(uint32_t x) { return x; }
static inline uint64_t Le64FromHost(uint64_t x) { return x; }
static inline uint64_t HostFromLe64(uint64_t x) { return x; }
...
static inline uint32_t Le32FromHost(uint32_t x) { return _byteswap_ulong(x); }
...
static inline uint32_t Le32FromHost(uint32_t x) { return __builtin_bswap32(x); }
