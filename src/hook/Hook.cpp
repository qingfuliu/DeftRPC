...
ssize_t read(int fd, void *buf, size_t count) { return IOBase(read_t, CLSN::Event::Read, fd, buf, count); }

ssize_t write(int fd, const void *buf, size_t count) { return IOBase(write_t, CLSN::Event::Write, fd, buf, count); }
...
bool Is_Enable_Hook() noexcept { return CLSN::enableHook; }
...
bool Disable_Enable_Hook() noexcept { CLSN::enableHook = false; }